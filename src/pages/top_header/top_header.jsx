    ...
    return <>
        <div className="top_header">
                ...
                <div className="max_width">
                    <div className="front_container">
                        ...
                        <div className="search_box center">
                            <input type="text" name="username" id="username" value={"Pritika Sharma"} disabled/>
                        </div>
                    </div>
            ...
            <div className="mobile_connect_bar">
                ...
                <div className="tab">
                    <a href="https://www.linkedin.com/in/pritika-sharma-a53518211/">LinkedIn</a>
                </div>
                <div className="tab">
                    <a href="https://twitter.com/Pritika63790947?t=rBX6fOt32tJ4r0iyvKuJow&s=08">Twitter</a>
                </div>
                <div className="tab">
                    <a href="https://github.com/Pritika15">Github</a>
                </div>
                <div className="tab">
                    <a href="mailto:: sharmapritika131@gmail.com">Contact</a>
                </div>
            </div>
            <ul className="connect_bar">
                ...
                <li className="connect_nav">
                    ...
                    <a href={'https://www.linkedin.com/in/pritika-sharma-a53518211/'}>
                        LinkedIn
                    </a>
                </li>
                <li className="connect_nav">
                    ...
                    <a href={'https://twitter.com/Pritika63790947?t=rBX6fOt32tJ4r0iyvKuJow&s=08'}>
                        Twitter
                    </a>
                </li>
                <li className="connect_nav">
                    ...
                    <a href={'mailto::sharmapritika131@gmail.com'}>
                        Contact
                    </a>
                </li>
                <li className="connect_nav">
